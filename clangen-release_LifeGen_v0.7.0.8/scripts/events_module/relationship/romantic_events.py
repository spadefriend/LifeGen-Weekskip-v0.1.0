...
class Romantic_Events():
    ...
    def start_interaction(cat_from, cat_to):
        ...
        relationship.log.append(interaction_str + f" - {cat_from.name} was {cat_from.moons} weeks old")

        if not relationship.opposite_relationship and cat_from.ID != cat_to.ID:
            relationship.link_relationship()
            relationship.opposite_relationship.log.append(interaction_str + f" - {cat_to.name} was {cat_to.moons} weeks old")
