...
class Relationship():
    ...
    def start_interaction(self) -> None:
        ...
        if self.cat_from.moons == 1:
            self.log.append(interaction_str + f" - {self.cat_from.name} was {self.cat_from.moons} week old")
        else:
            self.log.append(interaction_str + f" - {self.cat_from.name} was {self.cat_from.moons} weeks old")
