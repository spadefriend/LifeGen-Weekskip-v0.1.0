...
class EventsScreen(Screens):
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            if event.ui_element == self.timeskip_button and game.clan.your_cat.dead_for == 1 and not game.switches['continue_after_death']:
                ...
                DeathScreen('events screen')
                return
            if event.ui_element == self.timeskip_button and game.clan.your_cat.moons == 26 and game.clan.your_cat.status == 'kitten':
            ...
            if event.key == pygame.K_RIGHT:
                ...
                if game.clan.your_cat.moons == 25 and game.clan.your_cat.status == 'kitten':
                    PickPath('events screen')
    ...
    def screen_switches(self):
        ...
        self.season = pygame_gui.elements.UITextBox(f'Season: {game.clan.current_season} - Clan Age: {game.clan.age} weeks',
        ...
        if game.clan.your_cat.moons == -1:
            ...
            self.clan_age.set_text(f'Your age: {game.clan.your_cat.moons} weeks')
        elif game.clan.your_cat.moons == 1:
            self.clan_age.set_text(f'Your age: {game.clan.your_cat.moons} week')
    ...
    def timeskip_done(self):
        ...
        if self.event_display_type == "all events":
            ...
            if not self.all_events:
                self.all_events.append(Single_Event("Nothing interesting happened this week."))
            self.display_events = self.all_events
            self.update_list_buttons(self.all_events_button)
        elif self.event_display_type == "ceremony events":
            self.display_events = self.ceremony_events
