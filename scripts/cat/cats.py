...
# pylint: disable=f-string-without-interpolation
    ...
    def add_to_clan(self) -> list:
        ...
        for child_id in children:
            ...
            if child.outside and not child.exiled and child.moons < 53:
                child.add_to_clan()
                ids.append(child_id)
    ...
    def is_potential_mate(self,
        ...
        # check for age
        if age_restriction:
            if (self.moons < 60 or other_cat.moons < 60) and not for_love_interest:
                return False
    ...
    def is_dateable(self,
        ...
        if age_restriction:
            if (self.moons < 53 or other_cat.moons < 53):
                ...
                if game.settings['random relation']:
                    if game.clan:
                        if the_cat == game.clan.instructor or the_cat == game.clan.demon:
                            ...
                            if randint(
                                    1, 100 - like
                            ) == 1 and self.moons > 52 and the_cat.moons > 52:
    ...
    for a in range(12):
        if a in e:
            ...
            game.choose_cats[a] = Cat(status=choice(
                ['kitten']), biome=None)
        if game.choose_cats[a].moons >= 650:
            game.choose_cats[a].moons = choice(range(500, 610))
