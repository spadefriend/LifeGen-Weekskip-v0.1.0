    ...
    def screen_switches(self):
        ...
        self.help_button = UIImageButton(scale(pygame.Rect(
            ...
            tool_tip_text="Your clan will catch some amount of prey over each timeskip, but successful hunting patrols are the most "
                          ...
                          "Freshkill can't be stored endlessly, after four weeks prey will rot and will be thrown away. "
                          "Cats under 9 weeks with a parent (queen) taking care of them don't need food. "
                          "<br><br>"
